...
class war_game_api_test(unittest.TestCase):
    ...
    @patch('source.war_game.DatabaseManager.reset_all_scores')
    def test_reset_all_scores(self, mock_reset_all_scores):
        mock_reset_all_scores.return_value = [{"name": "Alice", "wins": 2}, {"name": "Bob", "wins": 1}]
